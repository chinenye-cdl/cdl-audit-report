...
const seedFindings = [
  {id:1,title:"Wallet Compliance Assessment",cat:"Operations",status:"Open",days:142,flag:"Board",risk:"CDL–ROVA–FCMB data not synchronized in real-time. Inconsistent FCMB reporting creating reconciliation challenges.",action:"Reconcile data on CDL & ROVA ends. Push real-time data into ROVA. Enhance audit logs.",owner:"Mobile App Product Manager",update:"",attachment:null},
  {id:2,title:"Control Weakness – Alternative Number Reuse",cat:"Operations",status:"Open",days:129,flag:"Management",risk:"Same phone number can be added as alternative contact for multiple accounts without validation.",action:"Implement system control to flag or block reuse of same phone number across multiple accounts.",owner:"Head, Engineering/Solutions Architect",update:"",attachment:null},
  {id:3,title:"CBN Instant Payment Compliance — Fraud & Controls Gap Assessment",cat:"Operations",status:"Closed",days:114,flag:"Board",risk:"CBN circular mandated critical Instant Payment controls by July 1, 2026. Inflow fraud monitoring not implemented.",action:"Gap assessment completed. Time-bound remediation roadmap developed.",owner:"Team Lead, Risk Intelligence · Head of Products · Head, Engineering",update:"",attachment:null},
  {id:4,title:"Exposure of Sensitive Payload in Client-Side Storage",cat:"Technology",status:"Closed",days:null,flag:"Management",risk:"JWT tokens, full name, email, phone, financial system IDs and 2FA/PIN status exposed in local storage.",action:"Remove all auth tokens and PII from local storage. Migrate JWT to HttpOnly Secure cookies.",owner:"Head, Engineering/Solution Architect",update:"",attachment:null},
  {id:5,title:"Zeus Database – Inadequate Account Naming & Excessive Privileges",cat:"Technology",status:"Open",days:114,flag:"Management",risk:"Generic 'cdladmin' account lacks traceability. Lambda/S3/Comprehend assigned rds_superuser_role.",action:"Rename accounts for traceability. Revoke unnecessary rds_superuser_role privileges.",owner:"Head Enterprise Application & Database Support",update:"",attachment:null},
  {id:6,title:"Open CRC Issues on FEEX",cat:"Operations",status:"Closed",days:null,flag:"Management",risk:"140 open CRC issues between Jan–Feb 2026 exceeded 30-day resolution timeline.",action:"Enforce single source of truth for CRC queries. Profile resolvers on Feex.",owner:"Head, Digital Transformation",update:"",attachment:null},
  {id:7,title:"Double Disbursements to Clients with Conflicting Loan IDs",cat:"Operations",status:"Closed",days:null,flag:"Management",risk:"7 loans disbursed twice to clients with two loan IDs.",action:"Immediate loss recovery. Strengthen loan setup, validation, and disbursement controls.",owner:"Team Lead, Disbursement Management · Head, Enterprise Application",update:"",attachment:null},
  {id:8,title:"Multi-Profile Identity Exploitation",cat:"Operations",status:"Open",days:112,flag:"Management",risk:"Customers bypass 'One-User-One-Profile' by using NIN vs BVN with different phone numbers.",action:"Implement cross-referencing validation to link NIN and BVN to a single unique identity.",owner:"Head of Products · Head, Enterprise Application & Database Support",update:"",attachment:null},
